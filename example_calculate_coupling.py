"""
Example showing how to calculate cpu;plign effieincy of an arbitrary incident field into fiber modes
"""
...
f.make_arb_input_field('gaussian', power=power, location=posn_microns, sigma=sigma,
                       add_to_existing=False, show_plots=show_plots, phase=phase)

posn_microns = [13, 0]
phase = np.pi
f.make_arb_input_field('gaussian', power=power, location=posn_microns, sigma=sigma,
                       add_to_existing=True, show_plots=show_plots, phase=phase)
